				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${studentList}" var="item">
								<tr>
									...
									<td>${item.mobile}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='/admin/editStudent?id=${item.studentId}'">修改</button>
										<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='/admin/removeStudent?id=${item.studentId}'">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
