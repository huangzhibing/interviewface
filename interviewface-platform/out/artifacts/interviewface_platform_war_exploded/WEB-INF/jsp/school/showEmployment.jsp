				...
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
							...
							<button class="btn btn-default col-md-2" style="margin-top: 20px" onClick="location.href='/school/addEmployment'">
								发布招聘需求
...
<%--										<button class="btn btn-default btn-xs btn-info" onClick="location.href='/school/editSchool?id=${item.schoolId}'">修改/审核</button>--%>
										<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='/school/removeEmployment?id=${item.employmentId}'">过期</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
