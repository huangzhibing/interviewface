...
<html>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
     <label class="navbar-brand" style="font-size: 1.5em;height: 30px;">招聘方注册：</label>
    </nav>
	 <div class="container col-lg-9 col-lg-offset-3">
	    <form id="form" action="/register" method="post" class="form-horizontal">
            <input name="role" value="3" style="display: none;">
            ...
            <div class="form-group" style="margin-bottom: 0em;">
                <label class="col-lg-4 control-label"><span>*</span>营业执照：</label>
                <div class="col-lg-4">
                    <input id="picPath" name="picPath" type="file"/><label class="error-msg"></label>
                </div>
            </div>
