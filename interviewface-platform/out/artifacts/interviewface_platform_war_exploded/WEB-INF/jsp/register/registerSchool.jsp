...
<html>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
     <label class="navbar-brand" style="font-size: 1.5em;height: 30px;">学校注册：</label>
    </nav>
	 <div class="container col-lg-9 col-lg-offset-3">
	    <form id="form" action="/register" method="post" class="form-horizontal">
            <input name="role" value="2" style="display: none;">
	         <div class="form-group" style="margin-bottom: 0em;">
	              <label class="col-lg-4 control-label"><span>*</span>用户名：</label>
	              <div class="col-lg-4">
	                  <input id="username" name="username" data-msg="请输入用户名" class="form-control" placeholder="用户名" style=""/><label class="error-msg"></label>
	              </div>
	         </div>
	         <div class="form-group" style="margin-bottom: 0em;">
	         ...
	         <div class="form-group" style="margin-bottom: 0em;">
	              <label class="col-lg-4 control-label"><span>*</span>学校名称：</label>
	              <div class="col-lg-4">
	                  <input id="name" name="name" data-msg="请输入学校名称" class="form-control" placeholder="学校名称"/><label class="error-msg"></label>
	              </div>
	         </div>
	         <div class="form-group" style="margin-bottom: 0em;">
